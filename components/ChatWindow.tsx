    ...
    >
      ...
      <form onSubmit={sendMessage} className="flex w-full flex-col">
        ...
        <div className="flex w-full mt-4">
          <input
            className="grow mr-4 p-2 rounded text-sm md:p-4" // Decrease padding and text size on mobile
            value={input}
          ...
          <button
            type="submit"
            className="shrink-0 px-3 py-2 bg-sky-600 rounded w-16 text-sm md:px-8 md:py-4 md:w-28" // Decrease padding, width, and text size on mobile
          >
            <div
              role="status"
              className={`${
