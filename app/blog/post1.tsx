  ...
  return (
    <div>
      ...
      <p className="text-lg mb-6 " style={{ textIndent: "2em" }}>
        ...
        attempts to create schedules that align with users&apos; cognitive
      ...
      <p className=" mb-6" style={{ textIndent: "2em" }}>
        ...
        times when a user&apos;s cognitive abilities in that area are likely to
        be at their peak, based on their personal profile and the time of day.
      </p>
      ...
      <p style={{ textIndent: "2em" }}>
        ...
        differences into account when creating schedules. The app doesn&apos;t
        assume that everyone performs best in the morning or evening, but
        instead tries to adapt to each user&apos;s unique patterns.
      </p>
      <br />
      <p className="mb-6" style={{ textIndent: "2em" }}>
      ...
      <p style={{ textIndent: "2em" }}>
        ...
        individual results may vary, the app&apos;s goal is to provide a
        scheduling approach informed by current scientific understanding of
        cognitive rhythms.
      </p>
    </div>
  );
